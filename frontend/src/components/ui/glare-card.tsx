...
export const GlareCard = ({
  ...
  className?: string;
  /** Classes for the tilted frame (border, etc.) */
  frameClassName?: string;
  /** Disables tilt / pointer interaction (e.g. locked lesson) */
  disabled?: boolean;
}) => {
  ...
  return (
    <div
      ...
      className={cn(
        "relative isolate [aspect-ratio:17/21] w-full min-w-0 transition-transform delay-[var(--delay)] duration-[var(--duration)] ease-[var(--easing)] will-change-transform [contain:layout_style] [perspective:600px]",
